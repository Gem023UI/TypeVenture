...
import { registerUser, loginUser, sendPasswordResetCode, resetPassword } from "../../api/user";
    ...
    <div className="login-register-wrapper">
      ...
      {showForgotPasswordModal && (
        ...
        >
          <div
            className="container"
            style={{ maxWidth: '450px', minHeight: 'auto', padding: '40px' }}
          ...
          >
            <button
              ...
              style={{
                ...
                color: '#666', cursor: 'pointer', width: '35px', height: '35px',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <div className="input-box">
                  <input
                    ...
                    style={{
                      ...
                      outline: 'none', transition: 'all 0.3s ease', marginBottom: '20px',
                    }}
                  />
                </div>
              ...
              <form onSubmit={handleResetPassword} style={{ width: '100%' }}>
                ...
                <div className="input-box">
                  <input
                    ...
                    disabled={resetLoading}
                    style={{
                      width: '100%', padding: '20px', fontSize: '32px',
                      fontWeight: 'bold', textAlign: 'center', letterSpacing: '10px',
                  ...
                  <div className="password-wrapper" style={{ marginBottom: '10px' }}>
                    <input
                      ...
                      style={{
                        ...
                        fontSize: '14px', border: '2px solid #ddd',
                        borderRadius: '8px', outline: 'none',
                      }}
                    />
                    <a type="button" className="eye-btn" onClick={() => setShowPassword(prev => !prev)} disabled={resetLoading}>
                      <FontAwesomeIcon icon={showPassword ? faEye : faEyeSlash} />
                    </a>
                  </div>
                  ...
                  <div className="password-wrapper">
                    ...
                    />
                    <a type="button" className="eye-btn" onClick={() => setShowConfirmPassword(prev => !prev)} disabled={resetLoading}>
                ...
                <button
                  ...
                  style={{
                    width: '100%', padding: '12px 30px',
                    background: 'transparent', color: '#0029FF',
                    border: '2px solid #0029FF', borderRadius: '8px',
                    fontSize: '14px', fontWeight: '600',
